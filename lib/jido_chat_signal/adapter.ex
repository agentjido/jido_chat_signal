defmodule Jido.Chat.Signal.Adapter do
  ...
  alias Jido.Chat.{Author, FileUpload, Incoming, Media, MediaType, PostPayload, Response}
  ...
  defp attachment_kind(media_type, filename), do: MediaType.kind(media_type, filename)
